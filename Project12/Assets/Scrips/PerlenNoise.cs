...
public class PerlenNoise : MonoBehaviour
{
    Dictionary<int, GameObject> tileset;
    Dictionary<int, GameObject> tile_groups;
    public GameObject prefab_grass;
    public GameObject prefab_path;
    public GameObject prefab_whiteflower;
    public GameObject prefab_yellowflower;
    ...
    void CreateTileset()
    {
        ...
        tileset.Add(1, prefab_path);
        tileset.Add(2, prefab_whiteflower);
        tileset.Add(3, prefab_yellowflower);
    }
