...
public class AdditionPerlenNoise : MonoBehaviour
{
    Dictionary<int, GameObject> tileset;
    Dictionary<int, GameObject> tile_groups;
    public GameObject prefab_Object1, prefab_Object2, prefab_Object3, prefab_Object4, prefab_Object5, prefab_Object6;
    ...
    void CreateTileset()
    {
        ...
        tileset.Add(0, prefab_Object1);
        tileset.Add(1, prefab_Object2);
        tileset.Add(2, prefab_Object3);
        tileset.Add(3, prefab_Object4);
        tileset.Add(4, prefab_Object5);
        tileset.Add(5, prefab_Object6);
    }
